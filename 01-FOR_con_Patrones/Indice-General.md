# 📌 Estructura de Carpeta: 01-FOR_con_Patrones
> ¡Bienvenido!
> En esta carpeta encontrarás varios ejercicios organizados en subcarpetas numeradas. Estos números no representan dificultad, solo indican el orden en el que fueron desarrollados.
>
> Cada ejercicio incluye:
> - Una descripción de la problemática.
> - Una propuesta de solución con comentarios para ayudarte a entender cada paso del código.
>
> La idea es que puedas revisar cada ejercicio a tu ritmo, entender el planteamiento y aprender a partir de la solución explicada. Si deseas, también puedo ayudarte a reorganizar o mejorar las descripciones de cada ejercicio.
...
Haz clic en el enlace de cada patrón para acceder a su documentación detallada, el reto del ejercicio y el código de ejemplo.
  ...
  1. [Triangulo cargado a la Izquierda](Triangulos/01-Triangulo_Izquierda/Ejercicio-Triangulo_Izquierda.md)
  2. [Triangulo cargado a la Derecha](Triangulos/02-Triangulo_Derecha/Ejercicio-Triangulo_Derecha.md)
